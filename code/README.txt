...
Qwen3: code for collecting hallucination generated by local HuggingFace-style Qwen3 checkpoints
-- main.py: main file for using local Qwen3 models (input must be JSONL lines: {"claim": str, "label": bool}; stages: hallu_data/cls/multi_ref/detection)
